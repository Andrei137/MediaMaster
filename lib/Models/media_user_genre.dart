...
class MediaUserGenre extends HiveObject {
  ...
  bool operator==(Object other) {
    ...
    return mediaId == (other as MediaUserGenre).mediaId && userId == other.userId && genreId == other.genreId;
  }
  ...
  Media get media {
    if(_media == null) {
      ...
      if(_media == null) {
        throw Exception("MediaUserGenre of mediaId $mediaId, userId $userId and genreId $genreId does not have an associated Media object or mediaId value is wrong");
      }
    }
    return _media!;
  }
  ...
  User get user {
    if(_user == null) {
      ...
      if(_user == null) {
        throw Exception("MediaUserGenre of mediaId $mediaId, userId $userId and genreId $genreId does not have an associated User object or userId value is wrong");
      }
    }
    return _user!;
  }
  ...
  Genre get genre {
    if(_genre == null) {
      ...
      if(_genre == null) {
        throw Exception("MediaUserGenre of mediaId $mediaId, userId $userId and genreId $genreId does not have an associated Genre object or genreId value is wrong");
      }
    }
    return _genre!;
  }
